...
namespace Presentation_Layer.Applications.Renew_Local_License
{
    public partial class frmRenewLocalDrivingLicenseApplication : Form
    {
        ...
        private void ucDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            {
                MessageBox.Show("Selected License is not yet expiared, it will expire on: " + clsFormat.DateToShort(ucDriverLicenseInfoWithFilter1.SelectedLicenseInfo.ExpirationDate)
